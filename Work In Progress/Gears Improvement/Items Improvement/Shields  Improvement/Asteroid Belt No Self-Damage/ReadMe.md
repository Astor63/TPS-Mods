## *Asteroid Belt* No Self-Damage

Made the *Meteor Explosion Damage Radius* not inflicting self-damage to fixes the issue of when a *Meteor Explosion Impact* is too close and would (repeatedly) put you down.

### Where to find it?

The *Asteroid Belt* is one of two possible rewards given by Sterwin if the *Master Poacher* is killed (instead of Deliver him the Wraiths) at the end of the optional mission *Guardian Hunter* in *Vorago Solitude*.
